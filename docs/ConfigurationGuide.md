...
| WALLET_DEEP_LINK_URI_SCHEME         | string                                   | Custom URI scheme to use for deep link when using encoded connection invitation (`{WALLET_DEEP_LINK_URI_SCHEME}://aries_proof-request?c_i={connection payload`)                                                                                                                                                                                                                                      | Default bcwallet                            |
