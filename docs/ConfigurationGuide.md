...
| USE_OOB_LOCAL_DID_SERVICE | bool                                   | Instructs VC-AuthN to use a local DID, useful if the agent service is not registered on the ledger with a public DID                                                                                                                                                                                                                                                                                                                                   | Use this when `ACAPY_WALLET_LOCAL_DID` is set to `true` in the agent.                                                                   |
